...
namespace Elemind\FilamentECharts\Commands;
...
class FilamentEChartsCommand extends Command
{
     ...
     * @var string
     */
    public $signature = 'make:filament-echarts {name?}';
     ...
     * @var string
     */
    public $description = 'Creates a Filament EChart Widget class.';
    ...
    public function __construct(Filesystem $files)
    {
        ...
        $this->files = $files;
        $this->chartOptions = config('filament-echarts.chart_options');
    }
